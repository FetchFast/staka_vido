...
##################################################
#set path and file information for stl and svg
...
workingpath = os.path.abspath("C:/Users/rlaney1/Documents/personal/test/")
stl_name = "yodabust.stl"
...
#start by analyzing the STL file itsel
#the STL should be centered on the origin
#find the min and max of the mesh, and move the STL
#so that the center is at the origin
original_mesh = mesh.Mesh.from_file(stl_name)
